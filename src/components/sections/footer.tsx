  ...
  return (
    <footer className="pt-20 pb-10 px-5 lg:px-7 xl:px-20 max-w-[1280px] mx-auto">
      <div className="size-full space-y-[80px] lg:space-y-[120px]">
        ...
        <div className="flex flex-col sm:flex-row gap-10 sm:gap-0 sm:items-center sm:justify-between">
          <div className="flex items-center gap-2.5">
            <Link
              href=""
              className="size-[68px] bg-[#1E0303] rounded-full grid place-items-center"
            >
              <svg
                width="20"
                height="20"
