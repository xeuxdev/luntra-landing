  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-[100px] px-4 sm:px-5 space-y-10 sm:space-y-[40px] md:space-y-[60px] min-[1440px]:px-20">
      <div className="space-y-8 sm:space-y-10 md:space-y-12 max-w-full sm:max-w-[750px] md:max-w-[850px] lg:max-w-[950px] mx-auto">
        <h3 className="text-3xl sm:text-4xl md:text-6xl lg:text-[82px] lg:leading-[90%] text-center max-w-full sm:max-w-[550px] md:max-w-[650px] lg:max-w-[750px] mx-auto font-medium">
        ...
        <div className="relative w-full">
          ...
          <div className="relative z-20 w-full h-full max-h-[794px] space-y-8">
            ...
            <div className="md:hidden grid grid-cols-2 gap-6 sm:gap-8 py-6">
            ...
            <div className="hidden md:block w-full h-[690px] relative">
              <div className="absolute top-11 left-11 w-[143px] h-[252px] flex justify-between flex-col">
              ...
              <div className="absolute top-11 right-11 w-[143px] h-[252px] flex justify-between flex-col">
              ...
              <div className="absolute bottom-11 right-11 w-[143px] h-[252px] flex justify-between flex-col">
                <p className="font-fragment text-2xl text-white/70">
                  DA Security
                </p>
                <p className="text-[40px]/[90%] font-medium tracking-[0%] text-right">
              ...
              <div className="absolute bottom-11 left-11 w-[143px] h-[252px] flex justify-between flex-col">
            ...
            <div className="bg-[#E16B551A] w-full h-auto min-h-[60px] sm:min-h-[68px] md:h-[74px] rounded-[20px] py-4 sm:py-5 md:py-6 px-3 sm:px-4 font-normal text-base sm:text-lg -tracking-[4%] text-[#E16B55] text-center flex items-center justify-center">
              <span>
